...
using Lab1TMDT.helper;

namespace Lab1TMDT.Controllers
{
    public class PaypalController : Controller
    {
        ...
        public ActionResult PaymentWithPayPal()
        {
            ...
            {
                Logger.Log("Error" + ex.Message); return View("FailureView");
            }
        ...
        private Payment CreatePayment(APIContext apiContext, string redirectUrl)
        {
            ...
            {
                cancel_url = redirectUrl,  return_url = redirectUrl
            };
        ...
        {
            var paymentExecution = new PaymentExecution() { payer_id = payerId }; this.payment = new Payment() { id = paymentId };
